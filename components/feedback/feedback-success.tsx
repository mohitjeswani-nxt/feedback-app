...
export function FeedbackSuccess({ ticketId, onViewFeedback, onSubmitAnother }: FeedbackSuccessProps) {
  ...
  return (
    <Card>
      <CardContent className="text-center py-12">
        ...
        <CardTitle className="text-2xl mb-2">Feedback Submitted Successfully!</CardTitle>
        ...
        <p className="text-sm text-muted-foreground mb-8">
          Please save this ticket ID for future reference. You can use it to track the status of your feedback.
        </p>
